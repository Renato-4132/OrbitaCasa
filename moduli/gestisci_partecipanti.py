...
def gestisci_partecipanti(self, target_popup=None):
    ...
    def rimuovi():
        ...
        # PULIZIA CORRETTA (uguale a on_select)
        nome_da_rimuovere = testo_riga
        for ico in ["CNT· ", "PER· ", "CTP· "]:
            nome_da_rimuovere = nome_da_rimuovere.replace(ico, "")
        nome_da_rimuovere = nome_da_rimuovere.split(" (")[0].strip()
