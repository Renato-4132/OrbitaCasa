...
def gestisci_archivi_pdf(self, categoria_iniziale=None, data_iniziale=None, importo_iniziale=None, tipo_iniziale="Uscita", descrizione_iniziale="", pdf_path_iniziale=None):
    ...
    def inserisci_documento_e_copia():
        ...
        try:
          ...
          if aggiorna_spesa:
            ...
            _metodo_sel_doc = self._metodo_pagamento_pulito(metodo_doc_var.get()) if hasattr(self, '_metodo_pagamento_pulito') else metodo_doc_var.get().strip()
    ...
    try:
        ...
        _metodi_doc = ["", "💰 Contanti", "🔄 RID/SDD", "🏦 Bonifico", "💎 C.Credito", "💜 C.Credito", "💳 C.Debito",
                       "📶 Contactless", "📯 PayPal", "📮 Bollettino", "🏪 Prepagata", "🪙 Assegno", "🔘 Revolut",
                       "🍎 Apple Pay", "🎯 Google Pay", "🏣 Postepay", "📲 Satispay", "🔀 Scalapay", "🛒 Amazon Pay"]
    ...
    def modifica_documento():
        ...
        metodo_e_var = tk.StringVar(value="")
        ...
        def salva_modifica():
            ...
            if aggiorna_spesa and idx_spesa != -1:
                ...
                _metodo_sel_e = self._metodo_pagamento_pulito(metodo_e_var.get()) if hasattr(self, '_metodo_pagamento_pulito') else metodo_e_var.get().strip()
