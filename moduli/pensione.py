...
def apri_fondo_pensione(self):
    ...
    def _confronto_tfr():
        # Stima: rivalutazione TFR standard (1,5% fisso + 75% inflazione annua) applicata
        # ad ogni versamento TFR dalla propria data ad oggi. È una stima approssimativa,
        # utile solo per un confronto di massima col fondo pensione.
        try:
    ...
    # ---------- builder generico liste (Versamenti / Valorizzazioni / Riscatti) ----------
