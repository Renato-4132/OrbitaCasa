...
def spesa_supermercato(self):
    ...
    def show_temporary_notification(parent, title, message, duration_ms=3000):
        ...
        _bordo_note = getattr(self, "COLOR_HIGHLIGHT", "#3B82F6")
        popup_note.config(bg="orange", highlightthickness=2,
                           highlightbackground=_bordo_note, highlightcolor=_bordo_note)
        popup_note.withdraw() 
    ...
    def _esegui_rinomina_supermercato(combo, treeview_crud, ricerca_var):
        ...
        entry.focus_set()
        rinomina_popup.bind("<Escape>", lambda e: rinomina_popup.destroy())
...
"Data Inizio Promo", "Data Scadenza Promo", "Prezzo Intero")
    ...
    risultati_tv = ttk.Treeview(frame_tv_risultati, columns=cols_risultati, show='headings', selectmode='browse')
    ...
    tv_lista_spesa = ttk.Treeview(frame_tv_lista, columns=cols_lista_spesa, show='tree headings', selectmode='browse')
    ...
    tree_super_crud = ttk.Treeview(frame_tv_crud, columns=cols_super, show='headings', selectmode='browse')
