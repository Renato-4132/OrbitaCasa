...
def gestisci_backup_popup(self):
    ...
    TIPI = {
        ...
        "studio_clienti.json":            "MyBusiness Clienti",
        "studio_appuntamenti.json":       "MyBusiness Appuntamenti",
        "studio_prestazioni.json":        "MyBusiness Prestazioni",
        "studio_fatture.json":            "MyBusiness Fatture",
