...
def apri_estratti_metodo(self, metodo=None, mese=None, anno=None, conto=None):
    ...
    def aggiorna(*_):
        ...
        _nome_metodo_sel = metodo_sel.split(" ", 1)[1].strip() if metodo_sel and " " in metodo_sel else ""
        _emoji_a_nome = {emoji: label.split(" ", 1)[1] for label, emoji in simboli_metodo.items()}
