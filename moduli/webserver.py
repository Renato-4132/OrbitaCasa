            ...
            <li class="voce-item">
                <div class="voce-actions">
                    ...
                    <button type="button" class="btn-action btn-delete"
                        onclick="apriModal('{v['data']}', '{v['idx']}', '{v['cat'].replace("'", "\\'")}', '{v['imp']:.2f}', {'1' if 'ALL·' in v['desc'] else '0'})">❌</button>
                ...
                <div id="{details_id}" class="op-details">
                    ...
                    <div class="op-row op-actions">
                        ...
                        <button type="button" class="op-btn danger"
                            onclick="event.stopPropagation(); apriModal('{data_str}', '{idx}', '{cat}', '{imp:.2f}', {'1' if 'ALL·' in desc else '0'})">
                            ❌ Cancella
                        </button>
                    </div>
                </div>
