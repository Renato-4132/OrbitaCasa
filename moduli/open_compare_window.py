...
def open_compare_window(self):
    ...
    btn_grafico_c.bind("<Button-1>", lambda e: self.crea_grafico_confronto(left_mese.get(), left_anno.get(), right_mese.get(), right_anno.get(), compare_by_year.get()))
...
def crea_grafico_confronto(self, m1_str, a1_str, m2_str, a2_str, per_anno, categoria_sel=None, mostra_future=True):
    try:
