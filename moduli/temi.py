...
def applica_temi(self, THEMA):
        if THEMA == "CHIARO":
            ...
            style.configure("GSaldoPositivo.TLabel", font=("Arial", 10, "bold"), background=COLOR_WIDGET_BG)
            style.map("GSaldoPositivo.TLabel", foreground=[('active', COLOR_GREEN_SMOOTH), ('!disabled', COLOR_GREEN_SMOOTH)])
            style.configure("GSaldoNegativo.TLabel", font=("Arial", 10, "bold"), background=COLOR_WIDGET_BG)
            style.map("GSaldoNegativo.TLabel", foreground=[('active', COLOR_RED_SMOOTH), ('!disabled', COLOR_RED_SMOOTH)])
