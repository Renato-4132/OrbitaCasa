...
def utenze(self):
    ...
    for utenza in utenze:
        ...
        tree = ttk.Treeview(tree_container, columns=("Mese", "Prec", "Att", "Consumo", "Stima"), show="headings", height=10)
    ...
    _tooltip_label = tk.Label(win, justify="left", bg="#2b2b2b", fg="#ffffff",
                               font=("Consolas", 9), padx=8, pady=6, bd=1, relief="solid")
