...
def registra_tutti_i_moduli(GestioneSpese):
    ...
    from moduli.fairshare import (
        ...
        mostra_riepilogo_fairshare_periodo, popup_personali, popup_grafico_categorie_personali, mostra_guida_dare_avere,_genera_testo_riepilogo_cronologico,
    ...
    _genera_testo_riepilogo_cronologico, get_fairshare_data_json)
