...
def setup_sidebar(self):
        ...
        self.menu_sidebar_data = [ 
                ...
                ("tools_B", "Opzioni", self.pop_opzioni), 
...
def _crea_menu(self):
        """Helper centralizzato per lo stile standard dei tk.Menu."""
...
def pop_gestione(self): 
        """Menu dedicato alla gestione pratica della casa e delle attività."""
        m = self._crea_menu(self)
...
def pop_analisi(self): 
        """Menu dedicato alle ricerche strutturate e alla reportistica avanzata."""
        m = self._crea_menu(self)
...
def pop_finanze(self): 
        """Menu per contabilità, bilanci storici, conti e integrazioni AI (Gemini)."""
        m = self._crea_menu(self)
        ...
        self._add_m_item(m, "Analisi Andamento Bilancio (Gemini)", "report", self.analizza_andamento_ia)
        self._add_m_item(m, "Analisi e Confronto Documenti (Gemini)", "report", self.confronta_bollette_ia)
        self._mostra_popup(m, 140)

def pop_ricorrenze(self): 
        """Menu dedicato alla pianificazione delle scadenze cicliche."""
        m = self._crea_menu(self)
...
def pop_opzioni(self): 
        """Menu per configurazioni generali, utility, stampe e aggiornamenti di sistema."""
        m = self._crea_menu(self)
...
def pop_info(self): 
        """Menu per la gestione strutturata, backup e ripristino del Database e Manuali."""
        m = self._crea_menu(self)
