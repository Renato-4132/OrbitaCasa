...
def mostra_piramide(self):
        ...
        [
            ...
            },
            {
                ...
                "moduli": [
                    ...
                    ("Chiedi IA",       "Chatbot database Gemini", _g("chiedi_ia_database")),
    ...
    canvas = tk.Canvas(win, width=CANVAS_W, height=CANVAS_H, bg=bg,
                        highlightthickness=2, highlightbackground=color_hi)
