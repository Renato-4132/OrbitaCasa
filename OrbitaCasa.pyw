...
class GestioneSpese(tk.Tk):
    ...
    def salva_modifica(self):
        ...
        _metodo_nuovo = self._metodo_pagamento_pulito(self.metodo_pagamento_var.get()) if hasattr(self, 'metodo_pagamento_var') else ""
        voce_new = SpesaEntry(
            cat, desc, imp, tipo,
    ...
    def salva_modifica_voce(self, params):
        ...
        if _conto_form and _conto_form != "(nessuno)":
            ...
            _nome_c_web = ""
        _metodo_form = params.get("metodo", [""])[0].strip()
...
def _rc():
    try:
        E_H_B = "06548e704b4fd6b99bce853a458784287c18ae9a7cbd4f5ca35de33322042441"
